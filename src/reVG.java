...
//                            if (map.containsKey(encrypted.charAt(k * ansn + j)))
//                                map.put(encrypted.charAt(k * ansn + j), map.get(encrypted.charAt(k * ansn + j)) + 1);
//                            else
//                                map.put(encrypted.charAt(k * ansn + j), 1);
                        }
                    }
                ...
                for(int t=0;t<ansn;++t) {//对于每个block
                   ...
                   // for(int i=0;i<1;++i)
                    ...
                    for (int i = 0; i < 26; ++i) {//移位数//////////////////
                        ...
                        System.out.println((char)(i+'a')+" "+M[i]+" "+close);
                    }
                    sump+=close;
                    anskey+=ansc;
