    ...
    public reVG() {
        解密Button.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                //统计概率
                double[] probability = new double[]{0.082, 0.015, 0.028, 0.043, 0.127, 0.022, 0.02, 0.061,
                        0.07, 0.002, 0.008, 0.04, 0.024, 0.067, 0.075, 0.019, 0.001, 0.06, 0.063, 0.091,
                ...
                System.out.println("密钥长度为："+ansn);
                System.out.println("密钥为："+anskey);
                System.out.println("平均重合指数："+sump/ansn);
                String keys=anskey;
                while(keys.length()<l)
                    keys+=anskey;
